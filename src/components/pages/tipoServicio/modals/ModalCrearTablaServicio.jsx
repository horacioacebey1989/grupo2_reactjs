...
//Inicia el proyecto
export default function ModalCrearTablaServicio() {
  ...
  const handleSubmit = () => {
    if (categoria != "") {
      ...
      fetch("http://localhost:3800/api/addTipoServicio", requestInit)
        .then((res) => res.json())
        .then((res) => {
          if (res) {
    ...
    <div>
      ...
      >
        <DialogTitle align="center" color="black">
          <Typography>Agregar Tipo de Servicio</Typography>
        </DialogTitle>
        <Divider></Divider>
        <DialogContent>
